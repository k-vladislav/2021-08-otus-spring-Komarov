...
public class ShellLibraryCommandsImpl implements ShellLibraryCommands {
    ...
    @Override
    @ShellMethod(key = "aab", value = "Add book's coauthor", group = "author")
    ...
    @Override
    @ShellMethod(key = "sab", value = "Show books for author", group = "author")
    ...
    @Override
    @ShellMethod(key = "ua", value = "Update author", group = "author")
    ...
    @Override
    @ShellMethod(key = "da", value = "Delete author", group = "author")
    ...
    @Override
    @ShellMethod(key = "gab", value = "Add genre for book", group = "genre")
    ...
    @Override
    @ShellMethod(key = "sgb", value = "Show books of genre", group = "genre")
    ...
    @Override
    @ShellMethod(key = "ug", value = "Update genre", group = "genre")
    ...
    @Override
    @ShellMethod(key = "dgb", value = "Delete genre for book", group = "genre")
    ...
    @Override
    @ShellMethod(key = "dg", value = "Delete genre", group = "genre")
